...
func main() {
	title := "Print to Markdown Installer"

	// 1. Confirmation Dialog
	promptText := "This installer will configure the virtual printer 'Print to Markdown' on your computer.\n\nDo you want to proceed?"
	...
	// 4. Success Dialog
	successText := "Installation completed successfully!\n\nThe virtual printer 'Print to Markdown' is now ready for use."
